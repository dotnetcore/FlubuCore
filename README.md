...
* [Web api is available for flubu. It has never been so easy to automate deployments remotely.](https://github.com/flubu-core/flubu.core/wiki/7-Web-Api:-Getting-started)
