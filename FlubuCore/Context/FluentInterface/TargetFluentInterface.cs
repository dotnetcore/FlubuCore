...
namespace FlubuCore.Context.FluentInterface
{
    public class TargetFluentInterface : ITargetFluentInterface
    {
        ...
        public ITargetFluentInterface DoAsync(Func<ITaskContextInternal, Task> targetAction, Action<DoTaskAsync> taskAction = null)
        {
            Target.DoAsync(targetAction, taskAction);
            return this;
        }
        ...
        public ITargetFluentInterface DoAsync<T>(Func<ITaskContextInternal, T, Task> targetAction, T param, Action<DoTaskAsync2<T>> taskAction = null)
        {
            Target.DoAsync(targetAction, param, taskAction);
            return this;
        }
        ...
        public ITargetFluentInterface DoAsync<T, T1>(Func<ITaskContextInternal, T, T1, Task> targetAction, T param, T1 param2, Action<DoTaskAsync3<T, T1>> taskAction = null)
        {
            Target.DoAsync(targetAction, param, param2, taskAction);
            return this;
        }
        ...
        {
            Target.DoAsync(targetAction, param, param2, param3, taskAction);
            return this;
        }

        public ITargetFluentInterface DoAsync<T, T1, T2>(Func<ITaskContextInternal, T, T1, T2, Task> targetAction, T param, T1 param2, T2 param3, Action<DoTaskAsync4<T, T1, T2>> taskAction = null)
        {
            Target.DoAsync(targetAction, param, param2, param3, taskAction);
            return this;
        }
        ...
        public ITargetFluentInterface DoAsync<T, T1, T2, T3>(Func<ITaskContextInternal, T, T1, T2, T3, Task> targetAction, T param, T1 param2, T2 param3, T3 param4,
            Action<DoTaskAsync5<T, T1, T2, T3>> taskAction = null)
        {
            Target.DoAsync(targetAction, param, param2, param3, param4, taskAction);
            return this;
        }
        ...
        public ITargetFluentInterface DoAsync<T, T1, T2, T3, T4>(Func<ITaskContextInternal, T, T1, T2, T3, T4, Task> targetAction, T param, T1 param2, T2 param3, T3 param4,
            T4 param5, Action<DoTaskAsync6<T, T1, T2, T3, T4>> taskAction = null)
        {
            Target.DoAsync(targetAction, param, param2, param3, param4, param5, taskAction);
            return this;
        }
