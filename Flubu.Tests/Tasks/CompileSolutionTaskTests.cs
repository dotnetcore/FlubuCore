...
namespace Flubu.Tests.Tasks
{
    ...
    public class CompileSolutionTaskTests : TaskTestBase
    {
        ...
        private void SetupRunProgramTask()
        {
            ...
            _runProgramTask.Setup(x => x.WithArguments("/p:Configuration={0}", "Release")).Returns(_runProgramTask.Object);
            ...
            _runProgramTask.Setup(x => x.WithArguments("/maxcpucount:{0}", "3")).Returns(_runProgramTask.Object);
        }
    }
}
