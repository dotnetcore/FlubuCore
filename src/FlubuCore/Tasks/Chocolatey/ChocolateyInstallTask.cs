...
namespace FlubuCore.Tasks.Chocolatey
{
    public class ChocolateyInstallTask : ChocolateyBaseTask<ChocolateyInstallTask>
    {
        ...
        public ChocolateyInstallTask InstallArguments(string arguments)
        {
        ...
        {
            WithArgumentsKeyFromAttribute(paswword, true);
            return this;
        }
        ...
        {
            WithArgumentsKeyFromAttribute(argument, true);
            return this;
        }
        ...
        {
            WithArgumentsKeyFromAttribute(parameter, true);
            return this;
        }
