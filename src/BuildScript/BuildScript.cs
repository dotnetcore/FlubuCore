...
public class  BuildScript : DefaultBuildScript
{
    ...
    protected override void ConfigureTargets(ITaskContext context)
    {
        ...
        var publishWebApi = context.CreateTarget("Publish.WebApi")
            ...
            .AddCoreTask(x => x.Publish("FlubuCore.WebApi").Framework("net5.0"))
            .AddCoreTask(x => x.Publish("FlubuCore.WebApi").Framework("net7.0"))
    ...
    public void PackageWebApi(ITarget target)
    {
        target.SetDescription("Prepares flubu web api deployment package.")
            .AddTask(x => x.PackageTask(Output.CombineWith("WebApiPackages\\net462"))
                ...
                .AddFileToPackage(@"packages\Newtonsoft.Json\13.0.1\lib\netstandard1.3\Newtonsoft.Json.dll", "lib")
                .AddFileToPackage(@"packages\litedb\5.0.11\lib\netstandard2.0\LiteDB.dll", "lib")
            ...
            .AddTask(x => x.PackageTask(Output.CombineWith("WebApiPackages\\NetCore3.1\\Linux"))
                ...
                .AddDirectoryToPackage(@"FlubuCore.WebApi.Updater\bin\Release\netcoreapp3.1", "FlubuCore.WebApi", true)
            ...
            .AddTask(x => x.PackageTask(Output.CombineWith("WebApiPackages\\Net5.0\\Linux"))
                .AddDirectoryToPackage(@"FlubuCore.WebApi\bin\Release\net5.0\publish", "FlubuCore.WebApi", true)
                .AddDirectoryToPackage(@"FlubuCore.WebApi.Updater\bin\Release\net5.0", "FlubuCore.WebApi", true)
                .AddFileToPackage("Deploy\\DeploymentScript.cs", "")
                .AddFileToPackage("Deploy\\DeploymentConfig.json", "")
                .AddFileToPackage("Deploy\\NetCore3.1\\Deploy.csproj", "")
                .AddFileToPackage("Deploy\\Deploy.bat", "")
                ...
                .AddFileToPackage(@"packages\netstandard.dll", "lib")
                .DisableLogging()
                .ZipPackage("FlubuCore.WebApi-Net5.0-LinuxMacInstaller", true))
            .AddTask(x => x.PackageTask(Output.CombineWith("WebApiPackages\\Net5.0\\Windows"))
                .AddDirectoryToPackage(@"FlubuCore.WebApi\bin\Release\net5.0\publish", "FlubuCore.WebApi", true)
                .AddDirectoryToPackage(@"FlubuCore.WebApi.Updater\bin\Release\net5.0", "FlubuCore.WebApi", true)
                .AddFileToPackage("Deploy\\DeploymentScript.cs", "")
                .AddFileToPackage("Deploy\\DeploymentConfig.json", "")
                ...
                .AddFileToPackage(@"packages\netstandard.dll", "lib")
                .DisableLogging()
                .ZipPackage("FlubuCore.WebApi-Net5.0-WindowsInstaller", true))
            .AddTask(x => x.PackageTask(Output.CombineWith("WebApiPackages\\Net7.0\\Linux"))
                .AddDirectoryToPackage(@"FlubuCore.WebApi\bin\Release\net7.0\publish", "FlubuCore.WebApi", true)
                .AddDirectoryToPackage(@"FlubuCore.WebApi.Updater\bin\Release\net7.0", "FlubuCore.WebApi", true)
                .AddFileToPackage("Deploy\\DeploymentScript.cs", "")
                .AddFileToPackage("Deploy\\DeploymentConfig.json", "")
                .AddFileToPackage("Deploy\\NetCore3.1\\Deploy.csproj", "")
                .AddFileToPackage("Deploy\\Deploy.bat", "")
                ...
                .AddFileToPackage(@"packages\netstandard.dll", "lib")
                .DisableLogging()
                .ZipPackage("FlubuCore.WebApi-Net7.0-LinuxMacInstaller", true))
            .AddTask(x => x.PackageTask(Output.CombineWith("WebApiPackages\\Net7.0\\Windows"))
                .AddDirectoryToPackage(@"FlubuCore.WebApi\bin\Release\net7.0\publish", "FlubuCore.WebApi", true)
                .AddDirectoryToPackage(@"FlubuCore.WebApi.Updater\bin\Release\net7.0", "FlubuCore.WebApi", true)
                .AddFileToPackage("Deploy\\DeploymentScript.cs", "")
                .AddFileToPackage("Deploy\\DeploymentConfig.json", "")
                ...
                .AddFileToPackage(@"packages\netstandard.dll", "lib")
                .DisableLogging()
                .ZipPackage("FlubuCore.WebApi-Net7.0-WindowsInstaller", true));
    }
}