    ...
    public class DeployScript : DefaultBuildScript
    {
        ...
        public void DeployWebApi(ITaskContext context)
        {
            ...
            else
            {
                ...
                connectionString = $"FileName=database.db; Connection=Shared; Password={liteDbPassword}";
            }
        ...
        private string GenerateRandomSecureString(int length, string allowedChars = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789") {
            if (length < 0)
